...
public class Lifter {
	...
	private final double right_lifter_finger_servo_close = 0.9;	//Fill These with correct values - 0.9
	private final double right_lifter_finger_servo_open = 0.01;		//Fill These with correct values
	
	private final double left_lifter_finger_servo_close = 0.1;	//Fill These with correct values
	private final double left_lifter_finger_servo_open = 0.99;	//Fill These with correct values - 0.99
